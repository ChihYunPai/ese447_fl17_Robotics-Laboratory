...
typedef struct {
  ...
  real_T Todegree[2];                  /* '<Root>/To degree' */
  real_T I;                            /* '<Root>/I' */
} BlockIO_untitled;
...
} ContinuousStates_untitled;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} StateDerivatives_untitled;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
} StateDisabled_untitled;
...
struct Parameters_untitled_ {
  ...
  real_T SineWave_Phase;               /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T pi_Gain;                      /* Expression: pi/4
                                        * Referenced by: '<Root>/2pi'
                                        */
  real_T Todegree2_Gain;               /* Expression: 180/pi
                                        * Referenced by: '<Root>/To degree2'
                                        */
  real_T P_Gain;                       /* Expression: 8
                                        * Referenced by: '<Root>/P'
                                        */
  real_T Integrator_IC;                /* Expression: 0
                                        * Referenced by: '<Root>/Integrator'
                                        */
  real_T D_Gain;                       /* Expression: .5
...
/* Continuous states (auto storage) */
extern ContinuousStates_untitled untitled_X;
