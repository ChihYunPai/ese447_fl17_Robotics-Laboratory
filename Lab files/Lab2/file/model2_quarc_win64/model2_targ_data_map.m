  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% model2_P.Todegree1_Gain
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 16;
	
	  ;% model2_P.SignalGenerator_Amplitude
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 17;
	
	  ;% model2_P.SignalGenerator_Frequency
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 18;
	
	  ;% model2_P.Todegree2_Gain
	  ...
	  ;% model2_P.Todegree3_Gain
	  section.data(29).logicalSrcIdx = 30;
	  section.data(29).dtTransOffset = 28;
	
	  ;% model2_P.Todegree_Gain
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% model2_DWork.Scope_PWORK.LoggedData
  ...
  targMap.checksum0 = 2744334598;
  targMap.checksum1 = 2965170420;
  targMap.checksum2 = 3371437042;
  targMap.checksum3 = 3630979061;
