...
typedef RT_MODEL_Lab4 RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Lab4(void);

/*
   extern void Lab4_initialize();
   extern void Lab4_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Lab4_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://Lab4:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Lab4 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
