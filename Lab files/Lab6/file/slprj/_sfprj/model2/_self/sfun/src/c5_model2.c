...
static const char * c5_debug_family_names[10] = { "nargin", "nargout", "q1",
  "q1dot", "q2", "q2dot", "q1_out", "q1dot_out", "q2_out", "q2dot_out" };
...
static real_T c5_emlrt_marshallIn(SFc5_model2InstanceStruct *chartInstance,
  const mxArray *c5_q2dot_out, const char_T *c5_identifier);
...
static real_T c5_mod(SFc5_model2InstanceStruct *chartInstance, real_T c5_x,
                     real_T c5_y);
static void c5_eml_scalar_eg(SFc5_model2InstanceStruct *chartInstance);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_model2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_model2InstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  real_T *c5_q2dot_out;
  uint8_T *c5_is_active_c5_model2;
  c5_q2dot_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c5_q2_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c5_q1dot_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_q1_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_is_active_c5_model2 = (uint8_T *)ssGetDWork(chartInstance->S, 3);
  c5_st = NULL;
  c5_st = NULL;
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_createcellarray(5), FALSE);
  c5_hoistedGlobal = *c5_q1_out;
  c5_u = c5_hoistedGlobal;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", &c5_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 0, c5_b_y);
  c5_b_hoistedGlobal = *c5_q1dot_out;
  c5_b_u = c5_b_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = *c5_q2_out;
  c5_c_u = c5_c_hoistedGlobal;
  c5_d_y = NULL;
  sf_mex_assign(&c5_d_y, sf_mex_create("y", &c5_c_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 2, c5_d_y);
  c5_d_hoistedGlobal = *c5_q2dot_out;
  c5_d_u = c5_d_hoistedGlobal;
  c5_e_y = NULL;
  sf_mex_assign(&c5_e_y, sf_mex_create("y", &c5_d_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 3, c5_e_y);
  c5_e_hoistedGlobal = *c5_is_active_c5_model2;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_q1_out = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    0)), "q1_out");
  *c5_q1dot_out = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c5_u, 1)), "q1dot_out");
  *c5_q2_out = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    2)), "q2_out");
  *c5_q2dot_out = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c5_u, 3)), "q2dot_out");
  *c5_is_active_c5_model2 = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 4)), "is_active_c5_model2");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_model2(chartInstance);
...
static void sf_c5_model2(SFc5_model2InstanceStruct *chartInstance)
{
  ...
  real_T *c5_b_q2;
  real_T *c5_b_q2dot;
  real_T *c5_b_q1dot_out;
  real_T *c5_b_q2_out;
  real_T *c5_b_q2dot_out;
  c5_b_q2dot_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c5_b_q2_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c5_b_q1dot_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c5_b_q1_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_q1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c5_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, *c5_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c5_b_q1, 0U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q1_out, 1U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q1dot, 2U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q2, 3U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q2dot, 4U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q1dot_out, 5U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q2_out, 6U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q2dot_out, 7U);
  *c5_sfEvent = CALL_EVENT;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c5_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c5_q1, 2U, c5_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c5_q1dot, 3U, c5_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c5_q2, 4U, c5_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c5_q2dot, 5U, c5_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c5_q1_out, 6U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c5_q1dot_out, 7U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c5_q2_out, 8U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c5_q2dot_out, 9U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, *c5_sfEvent, 2);
  c5_q1_out = c5_mod(chartInstance, c5_q1, 6.2831853071795862);
  _SFD_EML_CALL(0U, *c5_sfEvent, 3);
  c5_q1dot_out = c5_q1dot;
  _SFD_EML_CALL(0U, *c5_sfEvent, 4);
  c5_q2_out = c5_mod(chartInstance, c5_q2, 6.2831853071795862);
  _SFD_EML_CALL(0U, *c5_sfEvent, 5);
  c5_q2dot_out = c5_q2dot;
  _SFD_EML_CALL(0U, *c5_sfEvent, -5);
  sf_debug_symbol_scope_pop();
  *c5_b_q1_out = c5_q1_out;
  *c5_b_q1dot_out = c5_q1dot_out;
  *c5_b_q2_out = c5_q2_out;
  *c5_b_q2dot_out = c5_q2dot_out;
  ...
  const mxArray *c5_q2dot_out, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_q2dot_out),
    &c5_thisId);
  sf_mex_destroy(&c5_q2dot_out);
  return c5_y;
}
...
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  const mxArray *c5_q2dot_out;
  const char_T *c5_identifier;
  emlrtMsgIdentifier c5_thisId;
  real_T c5_y;
  SFc5_model2InstanceStruct *chartInstance;
  chartInstance = (SFc5_model2InstanceStruct *)chartInstanceVoid;
  c5_q2dot_out = sf_mex_dup(c5_mxArrayInData);
...
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[13])
{
  ...
  c5_info[0].fileTimeLo = 1289544892U;
  ...
  c5_info[1].fileTimeLo = 1326753196U;
  ...
  c5_info[2].fileTimeLo = 1286843996U;
  ...
  c5_info[3].fileTimeLo = 1330633634U;
  ...
  c5_info[4].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c5_info[4].fileTimeLo = 1286843996U;
  ...
  c5_info[5].fileTimeLo = 1286843926U;
  ...
  c5_info[6].fileTimeLo = 1307676438U;
  ...
  c5_info[7].fileTimeLo = 1286843912U;
  ...
  c5_info[8].fileTimeLo = 1326753196U;
  ...
  c5_info[9].fileTimeLo = 1286843982U;
  ...
  c5_info[10].fileTimeLo = 1326753196U;
  ...
  c5_info[11].fileTimeLo = 1326753196U;
  ...
  c5_info[12].fileTimeLo = 1289544892U;
  ...
  const mxArray *c5_is_active_c5_model2, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_is_active_c5_model2),
    &c5_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(636768427U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3222715737U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3985711409U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1281968776U);
}
...
mxArray *sf_c5_model2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("87Y0TUDb8FD1pOKXgPcDcH");
...
static const mxArray *sf_get_sim_state_info_c5_model2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"q1_out\",},{M[1],M[9],T\"q1dot_out\",},{M[1],M[10],T\"q2_out\",},{M[1],M[11],T\"q2dot_out\",},{M[8],M[0],T\"is_active_c5_model2\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"q1_out");
          _SFD_SET_DATA_PROPS(2,1,1,0,"q1dot");
          _SFD_SET_DATA_PROPS(3,1,1,0,"q2");
          _SFD_SET_DATA_PROPS(4,1,1,0,"q2dot");
          _SFD_SET_DATA_PROPS(5,2,0,1,"q1dot_out");
          _SFD_SET_DATA_PROPS(6,2,0,1,"q2_out");
          _SFD_SET_DATA_PROPS(7,2,0,1,"q2dot_out");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c5_q1_out);
          _SFD_SET_DATA_VALUE_PTR(2U, c5_q1dot);
          _SFD_SET_DATA_VALUE_PTR(3U, c5_q2);
          _SFD_SET_DATA_VALUE_PTR(4U, c5_q2dot);
          _SFD_SET_DATA_VALUE_PTR(5U, c5_q1dot_out);
          _SFD_SET_DATA_VALUE_PTR(6U, c5_q2_out);
          _SFD_SET_DATA_VALUE_PTR(7U, c5_q2dot_out);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c5_model2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1662663828U));
  ssSetChecksum1(S,(520200619U));
  ssSetChecksum2(S,(490094490U));
  ssSetChecksum3(S,(3626820536U));
