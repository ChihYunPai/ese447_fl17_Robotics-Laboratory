...
static void sf_c2_model2(SFc2_model2InstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_q2, 0U);
  _SFD_DATA_RANGE_CHECK(*c2_b_control, 1U);
  _SFD_DATA_RANGE_CHECK(*c2_b_q2dot, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_b_interval_1, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_b_interval_2, 4U);
  _SFD_DATA_RANGE_CHECK(*c2_b_oldControl, 5U);
  *c2_sfEvent = CALL_EVENT;
  ...
  c2_x = c2_A;
  c2_b_x = c2_x;
  c2_point_a = c2_b_x / 180.0;
  _SFD_EML_CALL(0U, *c2_sfEvent, 5);
  c2_b_a = 360.0 - c2_interval_1;
  c2_b_y = c2_b_a * 3.1415926535897931;
  c2_b_A = c2_b_y;
  c2_c_x = c2_b_A;
  c2_d_x = c2_c_x;
  c2_point_b = c2_d_x / 180.0;
  _SFD_EML_CALL(0U, *c2_sfEvent, 6);
  c2_c_a = 180.0 - c2_interval_2;
  c2_c_y = c2_c_a * 3.1415926535897931;
  c2_c_A = c2_c_y;
  c2_e_x = c2_c_A;
  c2_f_x = c2_e_x;
  c2_point_c = c2_f_x / 180.0;
  _SFD_EML_CALL(0U, *c2_sfEvent, 7);
  c2_d_a = 180.0 + c2_interval_2;
  c2_d_y = c2_d_a * 3.1415926535897931;
  c2_d_A = c2_d_y;
  c2_g_x = c2_d_A;
  c2_h_x = c2_g_x;
  c2_point_d = c2_h_x / 180.0;
  _SFD_EML_CALL(0U, *c2_sfEvent, 10);
  guard4 = FALSE;
  if (CV_EML_COND(0, 1, 0, c2_q2 < c2_point_a)) {
    guard4 = TRUE;
  } else if (CV_EML_COND(0, 1, 1, c2_q2 > c2_point_b)) {
    guard4 = TRUE;
  } else {
    ...
    guard5 = FALSE;
    if (CV_EML_COND(0, 1, 2, c2_q2 > c2_point_c)) {
      if (CV_EML_COND(0, 1, 3, c2_q2 < c2_point_d)) {
  ...
  guard1 = FALSE;
  if (CV_EML_COND(0, 1, 4, c2_oldControl == 1.0)) {
    if (CV_EML_COND(0, 1, 5, c2_currentState == 3.0)) {
  ...
  if (guard1 == TRUE) {
    ...
    guard2 = FALSE;
    if (CV_EML_COND(0, 1, 6, c2_oldControl == 2.0)) {
      if (CV_EML_COND(0, 1, 7, c2_currentState == 1.0)) {
    ...
    if (guard2 == TRUE) {
      ...
      guard3 = FALSE;
      if (CV_EML_COND(0, 1, 8, c2_oldControl == 3.0)) {
        if (CV_EML_COND(0, 1, 9, c2_currentState == 2.0)) {
...
const mxArray *sf_c2_model2_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[0].fileTimeLo = 1289544892U;
  ...
  (*c2_b_info)[1].fileTimeLo = 1342836144U;
  (*c2_b_info)[1].fileTimeHi = 0U;
  (*c2_b_info)[1].mFileTimeLo = 1319755166U;
  ...
  (*c2_b_info)[2].fileTimeLo = 1286844044U;
  ...
  (*c2_b_info)[3].fileTimeLo = 1313373010U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1052513143U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3996039057U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(882089486U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1217432172U);
}
...
mxArray *sf_c2_model2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("CK18zZeyPd3bZv0ETy8y3G");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,256,288,311,400);
        _SFD_CV_INIT_EML_IF(0,1,1,311,347,370,400);
        _SFD_CV_INIT_EML_IF(0,1,2,402,441,461,617);
        _SFD_CV_INIT_EML_IF(0,1,3,461,504,522,617);
        _SFD_CV_INIT_EML_IF(0,1,4,522,565,583,617);

        {
          static int condStart[] = { 259, 275 };

          static int condEnd[] = { 271, 287 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,259,287,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 318, 334 };

          static int condEnd[] = { 330, 346 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,318,346,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 405, 424 };

          static int condEnd[] = { 420, 441 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,405,441,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 468, 487 };

          static int condEnd[] = { 483, 504 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,468,504,2,6,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 529, 548 };

          static int condEnd[] = { 544, 565 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,4,529,565,2,8,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c2_model2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3691463017U));
  ssSetChecksum1(S,(174150606U));
  ssSetChecksum2(S,(1941279358U));
  ssSetChecksum3(S,(1541541278U));
