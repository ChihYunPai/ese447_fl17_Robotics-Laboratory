...
MODEL                = connect
MODULES              = connect_data.c connect_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = connect.mk
...
MODELLIB                  = connectlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = connect_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);H:\winprofile\desktop\Lab5_new\connect_quarc_win64
