 ...
 */
#ifndef RTW_HEADER_connect_h_
#define RTW_HEADER_connect_h_
#ifndef connect_COMMON_INCLUDES_
# define connect_COMMON_INCLUDES_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* connect_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T Todegree1;                    /* '<Root>/To degree1' */
  real_T Todegree2;                    /* '<Root>/To degree2' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Saturation;                   /* '<Root>/Saturation' */
  real_T Todegree3;                    /* '<Root>/To degree3' */
  real_T Todegree[3];                  /* '<Root>/To degree' */
  real_T I;                            /* '<Root>/I' */
} BlockIO_connect;
...
} ContinuousStates_connect;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} StateDerivatives_connect;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} StateDisabled_connect;
...
struct Parameters_connect_ {
  ...
  real_T Toradius_Gain;                /* Expression: 2*pi/4096
                                        ...
                                        */
  real_T Todegree1_Gain;               /* Expression: 180/pi
                                        * Referenced by: '<Root>/To degree1'
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: pi/4
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T SignalGenerator_Frequency;    /* Expression: 0.5
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T Todegree2_Gain;               /* Expression: 180/pi
                                        * Referenced by: '<Root>/To degree2'
                                        */
  real_T P_Gain;                       /* Expression: 20
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Todegree3_Gain;               /* Expression: 180/pi
                                        * Referenced by: '<Root>/To degree3'
                                        */
  real_T Todegree_Gain;                /* Expression: 180/pi
                                        * Referenced by: '<Root>/To degree'
                                        */
  real_T I_Gain;                       /* Expression: 2
...
extern Parameters_connect connect_P;

/* Block signals (auto storage) */
extern BlockIO_connect connect_B;

/* Continuous states (auto storage) */
extern ContinuousStates_connect connect_X;

/* Block states (auto storage) */
extern D_Work_connect connect_DWork;

/* Model entry point functions */
extern void connect_initialize(void);
extern void connect_step(void);
extern void connect_terminate(void);

/* Real-time Model object */
extern RT_MODEL_connect *const connect_M;
