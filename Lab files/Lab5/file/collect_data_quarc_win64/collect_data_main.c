 ...
 *
 * Date:           Thu Nov 02 11:40:14 2017
 * Model version:  1.17
 * Matlab version: 8.3 (R2012b) 20-Jul-2012
 ****************************************************************************/
...
typedef RT_MODEL_collect_data RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * collect_data(void);

/*
   extern void collect_data_initialize();
   extern void collect_data_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(collect_data_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://collect_data:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: collect_data -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
