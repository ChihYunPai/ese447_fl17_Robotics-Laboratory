...
MODEL                = collect_data
MODULES              = collect_data_data.c collect_data_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = collect_data.mk
...
NCSTATES             = 4
COMPUTER             = PCWIN64
BUILDARGS            =  GENERATE_REPORT=0 MAT_FILE=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = collect_datalib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = collect_data_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);H:\winprofile\desktop\Lab5_new\collect_data_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);H:\winprofile\desktop\Lab5_new
