...
MODEL                = model2
MODULES              = model2_data.c model2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = model2.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);H:\winprofile\desktop\Lab5_new\model2_quarc_win64
