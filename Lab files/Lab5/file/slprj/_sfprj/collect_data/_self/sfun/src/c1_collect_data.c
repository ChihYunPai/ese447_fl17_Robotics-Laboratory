...
static void initialize_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static void initialize_params_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static void enable_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static void disable_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_collect_data
  (SFc1_collect_dataInstanceStruct *chartInstance);
static void ext_mode_exec_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_collect_data
  (SFc1_collect_dataInstanceStruct *chartInstance);
static void set_sim_state_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static void sf_c1_collect_data(SFc1_collect_dataInstanceStruct *chartInstance);
static void c1_chartstep_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
static void initSimStructsc1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance);
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_collect_dataInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_b_emlrt_marshallIn(SFc1_collect_dataInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_collect_dataInstanceStruct *chartInstance,
...
static void c1_eml_scalar_eg(SFc1_collect_dataInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_collect_dataInstanceStruct *chartInstance);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_collect_dataInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_collect_dataInstanceStruct
  *chartInstance, const mxArray *c1_is_active_c1_collect_data, const char_T
  *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_collect_dataInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_collect_dataInstanceStruct *chartInstance);
...
{
  int32_T *c1_sfEvent;
  uint8_T *c1_is_active_c1_collect_data;
  c1_is_active_c1_collect_data = (uint8_T *)ssGetDWork(chartInstance->S, 3);
  c1_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c1_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c1_is_active_c1_collect_data = 0U;
}
...
static void ext_mode_exec_c1_collect_data(SFc1_collect_dataInstanceStruct
  *chartInstance)
{
  c1_update_debugger_state_c1_collect_data(chartInstance);
}
  ...
  (SFc1_collect_dataInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = *c1_is_active_c1_collect_data;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_is_active_c1_collect_data = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 0)), "is_active_c1_collect_data");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_collect_data(chartInstance);
...
static void sf_c1_collect_data(SFc1_collect_dataInstanceStruct *chartInstance)
{
  ...
  *c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_collect_data(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_collect_dataInstanceStruct *chartInstance;
  chartInstance = (SFc1_collect_dataInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_collect_data_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_is_active_c1_collect_data), &c1_thisId);
  sf_mex_destroy(&c1_is_active_c1_collect_data);
  return c1_y;
}
...
void sf_c1_collect_data_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(767805142U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3683952052U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3838298641U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2875220716U);
}

mxArray *sf_c1_collect_data_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("sBj912ADk5zY3EkD5o9aVE");
...
static const mxArray *sf_get_sim_state_info_c1_collect_data(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c1_collect_data\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_collect_data_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_collect_dataInstanceStruct *chartInstance;
    chartInstance = (SFc1_collect_dataInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_collect_data(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_collect_dataInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_collect_dataInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_collect_data((SFc1_collect_dataInstanceStruct*)
    chartInstanceVar);
  initialize_c1_collect_data((SFc1_collect_dataInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_collect_data(void *chartInstanceVar)
{
  enable_c1_collect_data((SFc1_collect_dataInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_collect_data(void *chartInstanceVar)
{
  disable_c1_collect_data((SFc1_collect_dataInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_collect_data(void *chartInstanceVar)
{
  sf_c1_collect_data((SFc1_collect_dataInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_collect_data(void *chartInstanceVar)
{
  ext_mode_exec_c1_collect_data((SFc1_collect_dataInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_collect_data(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_collect_data
    ((SFc1_collect_dataInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_collect_data();/* state var info */
...
extern void sf_internal_set_sim_state_c1_collect_data(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_collect_data((SFc1_collect_dataInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_collect_data(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_collect_data(S);
}

static void sf_opaque_set_sim_state_c1_collect_data(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c1_collect_data(S, st);
}

static void sf_opaque_terminate_c1_collect_data(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_collect_dataInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_collect_data((SFc1_collect_dataInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_collect_data((SFc1_collect_dataInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_collect_data(SimStruct *S)
{
  int i;
...
mxArray *sf_c1_collect_data_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c1_collect_data\",T\"is_active_c1_collect_data\"}}"
  };
...
static void mdlSetWorkWidths_c1_collect_data(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_collect_data_optimization_info();
  ...
  ssSetChecksum0(S,(625355506U));
  ssSetChecksum1(S,(1684404572U));
  ssSetChecksum2(S,(2550034349U));
  ssSetChecksum3(S,(86874297U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_collect_data(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_collect_data(SimStruct *S)
{
  SFc1_collect_dataInstanceStruct *chartInstance;
  chartInstance = (SFc1_collect_dataInstanceStruct *)malloc(sizeof
    (SFc1_collect_dataInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_collect_dataInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_collect_data;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_collect_data;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_collect_data;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_collect_data;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_collect_data;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_collect_data;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_collect_data;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_collect_data;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_collect_data;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_collect_data;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_collect_data;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c1_collect_data;
...
void c1_collect_data_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_collect_data(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_collect_data(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_collect_data(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_collect_data_method_dispatcher.\n"
