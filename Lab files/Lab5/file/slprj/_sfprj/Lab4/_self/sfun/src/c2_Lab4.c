...
static void initialize_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void initialize_params_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void enable_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void disable_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Lab4(SFc2_Lab4InstanceStruct
  *chartInstance);
static void ext_mode_exec_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Lab4(SFc2_Lab4InstanceStruct
  *chartInstance);
static void set_sim_state_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance, const
  mxArray *c2_st);
static void finalize_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void sf_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void c2_chartstep_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void initSimStructsc2_Lab4(SFc2_Lab4InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance, const
  mxArray *c2_Xdot, const char_T *c2_identifier, real_T c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance, const
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_d_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance, const
  mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[2]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance, const
  mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[4]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[30]);
static real_T c2_mpower(SFc2_Lab4InstanceStruct *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_Lab4InstanceStruct *chartInstance);
static void c2_eml_warning(SFc2_Lab4InstanceStruct *chartInstance);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance,
  const mxArray *c2_is_active_c2_Lab4, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_Lab4InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Lab4InstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance)
{
  int32_T *c2_sfEvent;
  uint8_T *c2_is_active_c2_Lab4;
  c2_is_active_c2_Lab4 = (uint8_T *)ssGetDWork(chartInstance->S, 3);
  c2_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c2_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c2_is_active_c2_Lab4 = 0U;
}
...
static void ext_mode_exec_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance)
{
  c2_update_debugger_state_c2_Lab4(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = *c2_is_active_c2_Lab4;
  ...
  mxArray *c2_st)
{
  ...
  *c2_is_active_c2_Lab4 = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 1)), "is_active_c2_Lab4");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Lab4(chartInstance);
...
static void sf_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance)
{
  ...
  *c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Lab4(chartInstance);
...
static void c2_chartstep_c2_Lab4(SFc2_Lab4InstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_theta5, 8U, c2_d_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_theta6, 9U, c2_d_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  c2_k_b = c2_r_x;
  c2_g2 = -0.90289062499999584 * c2_k_b;
  ...
  for (c2_i7 = 0; c2_i7 < 4; c2_i7++) {
    c2_e_a[c2_i7] = c2_C[c2_i7];
  }

  for (c2_i8 = 0; c2_i8 < 2; c2_i8++) {
    c2_l_b[c2_i8] = c2_qdot[c2_i8];
  }
  ...
  for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
    ...
    for (c2_i11 = 0; c2_i11 < 2; c2_i11++) {
      c2_g_y[c2_i9] += c2_e_a[c2_i10 + c2_i9] * c2_l_b[c2_i11];
      c2_i10 += 2;
    }
  }

  for (c2_i12 = 0; c2_i12 < 4; c2_i12++) {
    c2_e_a[c2_i12] = c2_M[c2_i12];
  }
  ...
  c2_db_x = c2_e_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c2_r2), 1, 2, 1, 0) - 1];
  c2_l_y = c2_e_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) - 1];
  c2_a21 = c2_db_x / c2_l_y;
  c2_f_a = c2_a21;
  c2_m_b = c2_e_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) + 1];
  c2_m_y = c2_f_a * c2_m_b;
  ...
  c2_eml_scalar_eg(chartInstance);
  c2_g_a = c2_g_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) - 1];
  c2_n_b = c2_a21;
  c2_n_y = c2_g_a * c2_n_b;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[4];
  const mxArray *c2_y = NULL;
  SFc2_Lab4InstanceStruct *chartInstance;
  chartInstance = (SFc2_Lab4InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Lab4_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_is_active_c2_Lab4, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_is_active_c2_Lab4),
    &c2_thisId);
  sf_mex_destroy(&c2_is_active_c2_Lab4);
  return c2_y;
}
...
void sf_c2_Lab4_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(239323456U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1935823278U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2593591273U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(536626604U);
}

mxArray *sf_c2_Lab4_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("otIotiCAqNI0ci4n73LWiD");
...
static const mxArray *sf_get_sim_state_info_c2_Lab4(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Xdot\",},{M[8],M[0],T\"is_active_c2_Lab4\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Lab4_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_Lab4InstanceStruct *chartInstance;
    chartInstance = (SFc2_Lab4InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_Lab4(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_Lab4InstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc2_Lab4InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
  initialize_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_Lab4(void *chartInstanceVar)
{
  enable_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Lab4(void *chartInstanceVar)
{
  disable_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Lab4(void *chartInstanceVar)
{
  sf_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_Lab4(void *chartInstanceVar)
{
  ext_mode_exec_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_Lab4(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Lab4((SFc2_Lab4InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_Lab4();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Lab4(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_Lab4((SFc2_Lab4InstanceStruct*)chartInfo->chartInstance,
                        mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_Lab4(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_Lab4(S);
}

static void sf_opaque_set_sim_state_c2_Lab4(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Lab4(S, st);
}

static void sf_opaque_terminate_c2_Lab4(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Lab4InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_Lab4((SFc2_Lab4InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Lab4(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_Lab4((SFc2_Lab4InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c2_Lab4_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c2_Lab4\",T\"is_active_c2_Lab4\"}}"
  };
...
static void mdlSetWorkWidths_c2_Lab4(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Lab4_optimization_info();
  ...
  ssSetChecksum0(S,(187144246U));
  ssSetChecksum1(S,(2474552121U));
  ssSetChecksum2(S,(884357839U));
  ssSetChecksum3(S,(547201793U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_Lab4(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Lab4(SimStruct *S)
{
  SFc2_Lab4InstanceStruct *chartInstance;
  chartInstance = (SFc2_Lab4InstanceStruct *)malloc(sizeof
    (SFc2_Lab4InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Lab4InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_Lab4;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_Lab4;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_Lab4;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Lab4;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Lab4;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_Lab4;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_Lab4;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_Lab4;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Lab4;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Lab4;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_Lab4;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c2_Lab4;
...
void c2_Lab4_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Lab4(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Lab4(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Lab4_method_dispatcher.\n"
