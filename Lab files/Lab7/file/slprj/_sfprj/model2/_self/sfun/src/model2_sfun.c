  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==6) {
    c6_model2_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (!strcmp(machineName, "model2")) {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        extern mxArray *sf_c6_model2_get_testpoint_info(void);
        plhs[0] = sf_c6_model2_get_testpoint_info();
        break;
      }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(422799088U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(289397323U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2395203550U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3674543714U);
       ...
       case 6:
        {
          ...
          sf_c6_model2_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1245979991U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2214264906U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3404744625U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(22869470U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "5YOr1YsgjQv3lmGaQSHoxE") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "MjLKtV4V4Y3szbIOl6lr9G") == 0) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "5GwTOhIjHMWLIm7y25nl1E") == 0) {
     ...
     case 5:
      {
        if (strcmp(aiChksum, "sncoEIwRr88Dx7ewQRtYmB") == 0) {
     ...
     case 6:
      {
        if (strcmp(aiChksum, "oAgmzd4iRnbtvfODRbdaCB") == 0) {
          extern mxArray *sf_c6_model2_get_autoinheritance_info(void);
          plhs[0] = sf_c6_model2_get_autoinheritance_info();
          break;
        }
     ...
     case 6:
      {
        ...
        mxArray *persistentMxArray = (mxArray *)
          sf_c6_model2_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
{
  _model2MachineNumber_ = sf_debug_initialize_machine("model2","sfun",0,6,0,0,0);
