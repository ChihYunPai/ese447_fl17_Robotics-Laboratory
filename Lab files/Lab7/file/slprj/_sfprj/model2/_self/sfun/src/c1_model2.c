...
static void initialize_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void initialize_params_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void enable_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void disable_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_model2(SFc1_model2InstanceStruct
  *chartInstance);
static void ext_mode_exec_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_model2(SFc1_model2InstanceStruct
  *chartInstance);
static void set_sim_state_c1_model2(SFc1_model2InstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void sf_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void c1_chartstep_c1_model2(SFc1_model2InstanceStruct *chartInstance);
static void initSimStructsc1_model2(SFc1_model2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_model2InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_b_emlrt_marshallIn(SFc1_model2InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_model2InstanceStruct *chartInstance,
...
static void c1_eml_scalar_eg(SFc1_model2InstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_model2InstanceStruct *chartInstance);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_model2InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_model2InstanceStruct *chartInstance,
  const mxArray *c1_is_active_c1_model2, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_model2InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_model2InstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c1_model2(SFc1_model2InstanceStruct *chartInstance)
{
  int32_T *c1_sfEvent;
  uint8_T *c1_is_active_c1_model2;
  c1_is_active_c1_model2 = (uint8_T *)ssGetDWork(chartInstance->S, 3);
  c1_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c1_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c1_is_active_c1_model2 = 0U;
}
...
static void ext_mode_exec_c1_model2(SFc1_model2InstanceStruct *chartInstance)
{
  c1_update_debugger_state_c1_model2(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = *c1_is_active_c1_model2;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_is_active_c1_model2 = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c1_u, 0)), "is_active_c1_model2");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_model2(chartInstance);
...
static void sf_c1_model2(SFc1_model2InstanceStruct *chartInstance)
{
  ...
  *c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_model2(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[4];
  const mxArray *c1_y = NULL;
  SFc1_model2InstanceStruct *chartInstance;
  chartInstance = (SFc1_model2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_model2_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[23])
{
  ...
  c1_info[22].context = "";
  c1_info[22].name = "drawnow";
  c1_info[22].dominantType = "";
  c1_info[22].resolved = "[IXMB]$matlabroot$/toolbox/matlab/graphics/drawnow";
  c1_info[22].fileTimeLo = MAX_uint32_T;
  c1_info[22].fileTimeHi = MAX_uint32_T;
  c1_info[22].mFileTimeLo = MAX_uint32_T;
  c1_info[22].mFileTimeHi = MAX_uint32_T;
}
  ...
  const mxArray *c1_is_active_c1_model2, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_is_active_c1_model2),
    &c1_thisId);
  sf_mex_destroy(&c1_is_active_c1_model2);
  return c1_y;
}
...
void sf_c1_model2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2616327345U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3629260955U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2147618899U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3753927218U);
}

mxArray *sf_c1_model2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("5YOr1YsgjQv3lmGaQSHoxE");
...
static const mxArray *sf_get_sim_state_info_c1_model2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c1_model2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_model2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_model2InstanceStruct *chartInstance;
    chartInstance = (SFc1_model2InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_model2(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_model2InstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_model2InstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
  initialize_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_model2(void *chartInstanceVar)
{
  enable_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_model2(void *chartInstanceVar)
{
  disable_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_model2(void *chartInstanceVar)
{
  sf_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_model2(void *chartInstanceVar)
{
  ext_mode_exec_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_model2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_model2((SFc1_model2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_model2();/* state var info */
...
extern void sf_internal_set_sim_state_c1_model2(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_model2((SFc1_model2InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_model2(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_model2(S);
}

static void sf_opaque_set_sim_state_c1_model2(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_model2(S, st);
}

static void sf_opaque_terminate_c1_model2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_model2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_model2((SFc1_model2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_model2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_model2((SFc1_model2InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c1_model2_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c1_model2\",T\"is_active_c1_model2\"}}"
  };
...
static void mdlSetWorkWidths_c1_model2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_model2_optimization_info();
  ...
  ssSetChecksum0(S,(2643303080U));
  ssSetChecksum1(S,(2536231453U));
  ssSetChecksum2(S,(4098426149U));
  ssSetChecksum3(S,(4035050056U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_model2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_model2(SimStruct *S)
{
  SFc1_model2InstanceStruct *chartInstance;
  chartInstance = (SFc1_model2InstanceStruct *)malloc(sizeof
    (SFc1_model2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_model2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_model2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_model2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_model2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_model2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_model2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_model2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_model2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_model2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_model2;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_model2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_model2;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c1_model2;
...
void c1_model2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_model2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_model2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_model2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_model2_method_dispatcher.\n"
