...
typedef struct {
  ...
  uint8_T is_active_c2_Lab3;           /* '<Root>/MATLAB Function' */
  boolean_T isStable;                  /* '<Root>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit;    /* '<Root>/MATLAB Function' */
} D_Work_Lab3;

/* Parameters (auto storage) */
struct Parameters_Lab3_ {
...
extern Parameters_Lab3 Lab3_P;

/* Block signals (auto storage) */
extern BlockIO_Lab3 Lab3_B;

/* Block states (auto storage) */
extern D_Work_Lab3 Lab3_DWork;
...
extern RT_MODEL_Lab3 *const Lab3_M;
