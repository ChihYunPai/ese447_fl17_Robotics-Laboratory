...
typedef RT_MODEL_Lab3 RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Lab3(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Lab3_initialize();
   extern void Lab3_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Lab3_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://Lab3:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Lab3 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
