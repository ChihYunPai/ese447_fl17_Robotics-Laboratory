 ...
 */
#ifndef RTW_HEADER_Read_h_
#define RTW_HEADER_Read_h_
#ifndef Read_COMMON_INCLUDES_
# define Read_COMMON_INCLUDES_
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
typedef struct {
  ...
  real_T HILReadEncoder1;              /* '<Root>/HIL Read Encoder1' */
} BlockIO_Read;
...
extern Parameters_Read Read_P;

/* Block signals (auto storage) */
extern BlockIO_Read Read_B;

/* Block states (auto storage) */
extern D_Work_Read Read_DWork;

/* Model entry point functions */
extern void Read_initialize(void);
extern void Read_step(void);
extern void Read_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Read *const Read_M;
